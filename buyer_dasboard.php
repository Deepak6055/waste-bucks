...
<head>
  ...
  <title>Waste Bucks-buyerdashboard</title>
...
<table>
  ...
  <?php while ($scrap = $result->fetch_assoc()): ?>
    <tr>
...
<br>
<a href="buyer_logout.php";style="border:orange; border-width:5px; border-style:solid;">Logout</a>
 <!-- ======= Footer ======= -->
